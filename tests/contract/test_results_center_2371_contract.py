"""Native Results Center contract regressions retained in 2.3.10.1."""
...
def test_results_center_is_retained_in_23101() -> None:
    assert read("src/picotoopet_core/product-version.txt").strip() == "2.3.10.1"
