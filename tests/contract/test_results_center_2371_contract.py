"""Native Results Center contract regressions retained in 2.3.12.2."""
...
def test_results_center_is_retained_in_23122() -> None:
    assert read("src/picotoopet_core/product-version.txt").strip() == "2.3.12.2"
