...
def test_business_automation_is_retained_in_current_rollup() -> None:
    # Version retention gate: 18.1 behavior remains present in the cumulative 27.1 product.
    assert _read("src/picotoopet_core/product-version.txt").strip() == "2.3.27.1"
