"""2.3.16.2 must retain and formally publish the cold-start recovery fix."""
...
EXPECTED_PRODUCT_VERSION = "2.3.16.2"
PREVIOUS_PRODUCT_VERSION = "2.3.16.1"
...
def test_rollup_uses_23162_on_every_active_version_surface() -> None:
