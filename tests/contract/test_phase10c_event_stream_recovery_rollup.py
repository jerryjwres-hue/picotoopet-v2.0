"""2.3.19.1 must retain and formally publish the cold-start recovery fix."""
...
EXPECTED_PRODUCT_VERSION = "2.3.19.1"
PREVIOUS_PRODUCT_VERSION = "2.3.18.1"
...
def test_rollup_uses_23191_on_every_active_version_surface() -> None:
