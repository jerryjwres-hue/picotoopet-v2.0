"""2.3.16.3 must retain and formally publish the cold-start recovery fix."""
...
EXPECTED_PRODUCT_VERSION = "2.3.16.3"
PREVIOUS_PRODUCT_VERSION = "2.3.16.2"
...
def test_rollup_uses_23163_on_every_active_version_surface() -> None:
