"""2.3.13.2 must retain and formally publish the cold-start recovery fix."""
...
EXPECTED_PRODUCT_VERSION = "2.3.13.2"
...
def test_rollup_uses_23132_on_every_active_version_surface() -> None:
