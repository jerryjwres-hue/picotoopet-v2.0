...
def test_canonical_product_version_is_23125() -> None:
    assert VERSION_FILE.read_text(encoding="utf-8").strip() == "2.3.12.5"
    assert PRODUCT_VERSION == "2.3.12.5"
    assert __version__ == PRODUCT_VERSION


@pytest.mark.parametrize(
    "value",
    ["2.3.12", "2.3.12.5.0", "v2.3.12.5", "2.3.x.5", ""],
)
