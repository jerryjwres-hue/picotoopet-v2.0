...
def test_canonical_product_version_is_23124() -> None:
    assert VERSION_FILE.read_text(encoding="utf-8").strip() == "2.3.12.4"
    assert PRODUCT_VERSION == "2.3.12.4"
    assert __version__ == PRODUCT_VERSION


@pytest.mark.parametrize(
    "value",
    ["2.3.12", "2.3.12.4.0", "v2.3.12.4", "2.3.x.4", ""],
)
