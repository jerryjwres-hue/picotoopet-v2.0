...
def test_business_tables_are_retained_through_current_schema(tmp_path: Path) -> None:
    ...
    # Schema retention gate      Business v1 facts must survive the cumulative schema-17 upgrade.
