...
def test_windows_builder_declares_native_wpf_goal_integrity_fields() -> None:
...
def test_windows_release_runs_goal_integrity_gate_before_artifact_upload() -> None:
    ...
    assert workflow.index(validator) < workflow.index(upload)
